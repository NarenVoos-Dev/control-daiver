        ...
        <div class="flex w-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <div class="w-full px-6 py-8 md:w-1/2">
                ...
                <form method="POST" action="{{ route('login') }}" class="mt-8">
                    ...
                    <div>
                        <x-label for="email" value="{{ __('Correo Electrónico') }}" class="text-gray-700 dark:text-gray-200"/>
                        <x-input id="email" class="block w-full mt-2" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                    </div>

                    <div class="mt-6">
                        <x-label for="password" value="{{ __('Contraseña') }}" class="text-gray-700 dark:text-gray-200"/>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        <label for="remember_me" class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600 ms-2 dark:text-gray-400">{{ __('Recordarme') }}</span>
                        </label>
