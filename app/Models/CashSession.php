...
class CashSession extends Model {
    use HasFactory;
    protected $fillable = [ 'business_id', 'user_id_opened', 'user_id_closed', 'opening_balance', 'closing_balance', 'calculated_balance', 'difference', 'status', 'notes', 'opened_at', 'closed_at' ];
